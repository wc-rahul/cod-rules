...
type Module = typeof import("../api.debug.payment-customizations.js")

type Info = GetInfo<{
  file: "routes/api.debug.payment-customizations.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.debug.payment-customizations.js");
}];
