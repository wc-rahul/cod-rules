...
type Module = typeof import("../api.payment-customization-activate.js")

type Info = GetInfo<{
  file: "routes/api.payment-customization-activate.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.payment-customization-activate.js");
}];
