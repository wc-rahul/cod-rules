...
type Module = typeof import("../api.payment-customization-create.js")

type Info = GetInfo<{
  file: "routes/api.payment-customization-create.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.payment-customization-create.js");
}];
