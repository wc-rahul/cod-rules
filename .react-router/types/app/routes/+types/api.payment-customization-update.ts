...
type Module = typeof import("../api.payment-customization-update.js")

type Info = GetInfo<{
  file: "routes/api.payment-customization-update.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.payment-customization-update.js");
}];
